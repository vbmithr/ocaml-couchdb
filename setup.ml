...
(* OASIS_START *)
(* DO NOT EDIT (digest: de36118930199a8f3b95df2d679db313) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\219\147\176\201\170\213\007'\213~%\189S!\161\169";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
